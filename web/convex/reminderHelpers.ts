...
//
// Uses `.first()` rather than `.unique()` so a freak collision (two
// users briefly holding the same code) doesn't error the webhook —
// whichever row is returned first wins, the loser's code stays unclaimed
// until they request a new one.
