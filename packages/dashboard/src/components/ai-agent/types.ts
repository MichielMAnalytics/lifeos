...
export const MODELS = [
  ...
  { id: "gpt", label: "GPT-5.4", icon: "/openai-icon.png", iconClass: "invert" },
  { id: "gpt-5.2", label: "GPT-5.2", icon: "/openai-icon.png", iconClass: "invert" },
  { id: "gpt-mini", label: "GPT-5 Mini", icon: "/openai-icon.png", iconClass: "invert" },
  { id: "gpt-nano", label: "GPT-5 Nano", icon: "/openai-icon.png", iconClass: "invert" },
